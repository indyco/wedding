...
function createStore(db) {
  ...
  function createInvitee(data) {
    ...
    // like "ABC" mints a fresh one instead of storing an empty string.
  ...
  function updateInvitee(id, data) {
    ...
    if ("invite_code" in params) {
      ...
      // path, so an invitee without one is unreachable.
      params.invite_code = normalizeCode(params.invite_code) || generateUniqueInviteCode();
    }
